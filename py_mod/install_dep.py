...
pkg_name = {
    ...
    "dnf": {
        ...
        "bash": "bash",
        "bash-completion": "bash-completion",
        "build-essential": "automake gcc make",
        "cmake": "cmake",
        "curl": "curl",
        "dunst": "dunst",
        "fvwm": "fvwm3",
        "git": "git",
        "libnotify": "",
        "lightdm": "lightdm lightdm-settings lightdm-gtk lightdm-gtk-greeter lightdm-gtk-greeter-settings",
        "pam": "",
        "python3": "python3",
        "rofi": "rofi",
        "rust": "rust cargo",
        ...
        "unzip": "unzip",
        "wget": "wget",
        "wpagui": "wpa_supplicant wpa_supplicant_gui",
        "xorg-xserver-utils": "dbus xorg-x11-drivers xorg-x11-util-macros xorg-x11-xauth xorg-x11-server-Xorg xset xsetroot xrdb",
        "xcb": "libxcb xcb-util",
        "xinit": "xorg-x11-xinit",
        "xterm": "xterm xterm-resize",
        "xz": "xz",
        "yazi": "",
        "zsh": "zsh",
    },
    "pacman": {
        ...
        "bash": "bash",
        "bash-completion": "bash-completion",
        "build-essential": "automake base-devel make",
        "cmake": "cmake",
        "curl": "curl",
        "dunst": "dunst",
        "fvwm": "fvwm3",
    ...
    "pkg": {
        ...
        "bash": "bash",
        "bash-completion": "bash-completion",
        "build-essential": "automake gcc gmake npm",
        "cmake": "cmake",
        "curl": "curl",
        "dunst": "dunst",
        "fvwm": "fvwm3",
